...
export const GROUP_JURISDICTIONS: GroupJurisdiction[] = [
  {
    key: 'kubwa',
    name: 'Kubwa Group',
    pastorName: 'Pastor Solomon (Kubwa Group Pastor)',
    pastorPhone: '+234 803 666 7788',
    pastorEmail: 'pastor.solomon@ceabuja.org',
  ...
  },
  {
    key: 'wuye',
    name: 'Wuye Group',
    pastorName: 'Pastor Akin (Wuye Group Pastor)',
    pastorPhone: '+234 803 111 2233',
    pastorEmail: 'pastor.akin@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Aloy Okei / Pastor David',
    pastorPhone: '+234 803 999 8888',
    pastorEmail: 'pastor.zonalchurch@ceabuja.org',
  ...
  },
  {
    key: 'gwarinpa',
    name: 'Gwarinpa Group',
    pastorName: 'Pastor Oche (Gwarinpa Group Pastor)',
    pastorPhone: '+234 803 444 5566',
    pastorEmail: 'pastor.oche@ceabuja.org',
  ...
  },
  {
    key: 'bwari',
    name: 'Bwari Group',
    pastorName: 'Pastor Joshua (Bwari Group Pastor)',
    pastorPhone: '+234 803 888 9900',
    pastorEmail: 'pastor.joshua@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Jeremiah (Gwagwalada Group Pastor)',
    pastorPhone: '+234 804 111 2200',
    pastorEmail: 'pastor.jeremiah@ceabuja.org',
  ...
  },
  {
    key: 'kuje',
    name: 'Kuje Group',
    pastorName: 'Pastor Ayuba (Kuje Group Pastor)',
    pastorPhone: '+234 805 111 4400',
    pastorEmail: 'pastor.ayuba@ceabuja.org',
  ...
  },
  {
    key: 'lokogoma',
    name: 'Lokogoma Group',
    pastorName: 'Pastor Chinedu (Lokogoma Group Pastor)',
    pastorPhone: '+234 806 222 5500',
    pastorEmail: 'pastor.chinedu@ceabuja.org',
  ...
  },
  {
    key: 'karmo',
    name: 'Karmo Group',
    pastorName: 'Pastor Uche (Karmo Group Pastor)',
    pastorPhone: '+234 803 333 4455',
    pastorEmail: 'pastor.uche@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Gideon (Airport Road Pastor)',
    pastorPhone: '+234 808 444 7700',
    pastorEmail: 'pastor.gideon@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Zephaniah (New Horizon Pastor)',
    pastorPhone: '+234 803 999 0011',
    pastorEmail: 'pastor.zephaniah@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Zachariah (Dutse Makaranta Pastor)',
    pastorPhone: '+234 810 666 9900',
    pastorEmail: 'pastor.zachariah@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Moses (Fruitful Vine Pastor)',
    pastorPhone: '+234 803 555 6677',
    pastorEmail: 'pastor.moses@ceabuja.org',
  ...
  },
  {
    key: 'deidei',
    name: 'Dei Dei Group',
    pastorName: 'Pastor Ezekiel (Dei Dei Pastor)',
    pastorPhone: '+234 807 333 6600',
    pastorEmail: 'pastor.ezekiel@ceabuja.org',
  ...
  },
  {
    key: 'byazhin',
    name: 'Byazhin Church',
    pastorName: 'Pastor Raphael (Byazhin Pastor)',
    pastorPhone: '+234 809 555 8800',
    pastorEmail: 'pastor.raphael@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Abraham (Wealthy Place Pastor)',
    pastorPhone: '+234 811 777 0011',
    pastorEmail: 'pastor.abraham@ceabuja.org',
  ...
  },
  {
    key: 'city_church',
    name: 'CE City Church',
    pastorName: 'Pastor Isaac (City Church Pastor)',
    pastorPhone: '+234 812 888 1122',
    pastorEmail: 'pastor.isaac@ceabuja.org',
  ...
  },
  {
    ...
    pastorName: 'Pastor Youth (Teens Church Pastor)',
    pastorPhone: '+234 813 999 2233',
    pastorEmail: 'pastor.youth@ceabuja.org',
